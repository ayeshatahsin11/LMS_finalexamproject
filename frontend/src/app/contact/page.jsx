...
export default function ContactPage() {
  ...
  const handleSubmit = (e) => {
    ...
    setSubmitting(true);
    // Note: there's no backend endpoint wired up to actually send this
    // message yet (would need an email service like Nodemailer/SendGrid
    // on the backend). This confirms the form works end-to-end on the
    // frontend and gives the user clear feedback in the meantime.
    setTimeout(() => {
      setSubmitting(false);
